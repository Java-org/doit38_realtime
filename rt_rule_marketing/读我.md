...
“易学在线”官网发布的视频中，对于 “跨规则上线时间段” 动态画像统计条件的处理中，有一个预计算 条件start - currentTime的时间分割预计算方案，而历史区段结束时间点，到规则正式就绪于运算机池，之间有一段时间差，这段时间差可能导致少量数据的漏计算；在本版本的代码中，已经提供了解决方案，可在主架构的processElement中看到